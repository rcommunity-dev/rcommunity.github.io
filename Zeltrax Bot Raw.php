...
$botToken = "1311572803:AAEx93xwsTjzqFUNRDnSYJzvXEPz9VnGJt4"; ////////////=========[Bot Token]==========////////
...
switch($message) {
case "/start":
sendMessage($chatId, "Hey! I am a CC-Checker bot with a few extras. Send /cmds for a list of all commands!<b>%0ABOT BY:</b> Rcommunity");
break;
case "/cmds":
...
$skeys = array(
  1 => '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', ///////////============[Enter atleast one sk key]==========//////////////
...
if (strpos($result, 'api_key_expired')) {
 	$d ="<b>DEAD KEY<u>%0AKEY:</u> <code>$sec</code> <u>%0AREASON:</u> <code>EXPIRED KEY</code><b>%0ABOT BY:</b> @ZeltraxRockz Zeltrax";
	sendMessage($chatId,$d);
}
elseif (strpos($result, 'Invalid API Key provided')) {
	$d ="<b>DEAD KEY</b><u>%0AKEY:</u> <code>$sec</code> <u>%0AREASON:</u> <code>INVALID KEY</code><b>%0ABOT BY:</b> @ZeltraxRockz Zeltrax";
	sendMessage($chatId,$d);
	}elseif (strpos($result, 'testmode_charges_only')) {
	$d ="<b>DEAD KEY</b><u>%0AKEY:</u> <code>$sec</code> <u>%0AREASON:</u> <code>testmode_charges_only</code><b>%0ABOT BY:</b> @ZeltraxRockz Zeltrax";
	sendMessage($chatId,$d);
}elseif (strpos($result, 'test_mode_live_card')) {
	$d ="<b>DEAD KEY</b><u>%0AKEY:</u> <code>$sec</code> <u>%0ARESPONSE:</u> <code>testmode_charges_only</code><b>%0ABOT BY:</b> @ZeltraxRockz Zeltrax";
	sendMessage($chatId,$d);
	}elseif (strpos($result, 'error')) {
	$d ="<b>DEAD KEY</b><u>%0AKEY:</u> <code>$sec</code> <u>%0ARESPONSE:</u> <code>An Error occurred...</code><b>%0ABOT BY:</b> @ZeltraxRockz Zeltrax";
	sendMessage($chatId,$d);
}else {
$d ="<b>LIVE KEY</b><u>%0AKEY:</u> <code>$sec</code> <u>%0ARESPONSE:</u> <code>SK LIVE!</code><b>%0ABOT BY:</b> @ZeltraxRockz Zeltrax";
    sendMessage($chatId,$d);
}}
